...
工作流每天更新网站后，会根据最近走势在巴基斯坦和印度之间选择更值得关注的市场，以“高位回落”“低位反弹”“连续上涨”等自然语言生成主题，并自动生成一张900×383像素的公众号封面图。封面以JPG附件发送到指定邮箱；邮件正文保留报价日期、昨日价格、人民币参考价及四国7日走势，底部提示读者点击“阅读原文”浏览详细内容。休市日使用最近一个有报价的交易日并明确标注日期。
