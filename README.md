...
面向微信公众号菜单的移动端网页，每日采集四个市场最近 7 个交易日数据。最新价格和四国横向比较统一折算为人民币元/吨；各市场趋势图使用当地原始报价及单位。
...
汇率来自 ExchangeRate-API 免费公开端点。折算价不含关税、增值税、保险及港杂费；美国人民币参考价直接按市场美分/磅报价折算，不代表完整进口成本。
...
仓库包含 `.github/workflows/pages.yml`：首次推送后会抓取四国最新数据、导出静态H5并部署到GitHub Pages；工作日北京时间21:00生成日报，周六09:00生成周报，周日休息。也可以在GitHub仓库的 **Actions** 页面手动运行。
...
- 周一至周五北京时间21:00发送当日报告；根据巴基斯坦和印度行情选择主题，并按实际报价日期使用“今日”“昨日”或具体日期作为标题前缀。
- 每份工作日日报自动生成一张900×383像素的公众号JPG封面，正文保留报价日期、当地原始价格、人民币参考价及四国7日走势。
- 每周六北京时间09:00发送刚结束一周的巴基斯坦和印度棉价周报，汇总周涨跌、周内区间和最新报价，并附带900×383像素的公众号周报JPG封面。
- 周日不发送邮件。所有报告底部提示读者点击“阅读原文”浏览详细内容；休市日使用最近一个有报价的交易日并明确标注日期。
