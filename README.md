...
工作流每天更新网站后，会根据最近走势在巴基斯坦和印度之间选择更值得关注的市场，以“高位回落”“低位反弹”“连续上涨”等自然语言生成主题，并自动生成一张900×1500像素的公众号竖版主题图。图片以内嵌附件发送到指定邮箱，保存后可直接上传公众号；邮件正文同时保留报价日期、昨日价格、人民币参考价及四国7日走势。休市日使用最近一个有报价的交易日并明确标注日期。
